...
public class ResDataBase{
  ...
  private static final String DATABASE_LOGIN_USER = "sandi";
  private static final String DATABASE_LOGIN_PW = "pass";
  ...
  public static List<ResListProfile> getRes(String thread_id){
    ...
    try{
      ...
      String getres="SELECT res_id, res_no, thread_id, res_user_name, to_char(res_date,'YYYY/MM/DD HH24:MI:SS DAY'), res_text FROM res_table WHERE thread_id='"+thread_id+"' ORDER BY res_id ";
      Statement stt2=cn.createStatement();
